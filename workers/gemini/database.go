...
func initDatabase(db *sql.DB) error {
	...
	possiblePaths := []string{
		...
		"../../scripts/init_database.sql",            // 从 workers/gemini 目录运行
		"../../../scripts/init_database.sql",         // 从 workers/gemini/cmd 目录运行
	}
...
func BuildContentJSON(text string, images []string, videos []string) (string, error) {
	content := ContentJSON{}

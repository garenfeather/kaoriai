...
OUTPUT_DIR="$SCRIPT_DIR/../parsed/claude_code/conversation"
...
go build -o "$BIN_DIR/claude_code_conversation_parse" "$SCRIPT_DIR/claude_code_conversation_parse.go"
...
if [ -z "$1" ]; then
    ...
    echo "示例: $0 data/claude_code/projects/-Users-your_username/session.jsonl"
    exit 1
fi
